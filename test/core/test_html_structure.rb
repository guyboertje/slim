...
<html></html>
  ...
  def test_html_tags
    source = %q{
html:p.left.top( *{id: 'fred'}.merge({href: 223}) data-id="foo" data-ref=show_first?(hash[:a]) selected) = "World"
}

    assert_html "<html:p class=\"left top\" data-id=\"foo\" data-ref=\"The letter a\" href=\"223\" id=\"fred\" selected=\"true\">World</html:p>", source
  end
